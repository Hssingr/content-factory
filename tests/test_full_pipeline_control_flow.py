...
class TestFullPipelineControlFlow(unittest.TestCase):
    def test_parent_visual_failure_gates_child_visuals_and_render(self):
        # Renamed from _execute_audio_through_render when Agent 6 metadata
        # generation was added as the step following render.
        src = inspect.getsource(pipeline._execute_audio_through_metadata)
